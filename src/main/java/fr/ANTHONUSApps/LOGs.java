...
import fr.ANTHONUSApps.Exceptions.LOGs.LogTypeAlreadyExistsException;
import fr.ANTHONUSApps.Exceptions.LOGs.LogTypeDoesntExistsException;
import fr.ANTHONUSApps.Exceptions.LOGs.RVBFormatException;
...
public class LOGs {
     ...
     * @param v    The green value of the new color.
     ...
     */
    public static void addLogType(String type, int r, int v, int b) throws LogTypeAlreadyExistsException, RVBFormatException {
        if (r > 255 || r < 0 || v > 255 || v < 0 || b > 255 || b < 0) {
            throw new RVBFormatException(r, v, b);
        }
